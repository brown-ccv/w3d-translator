...
class ContentSub(supermod.Content):
    def __init__(self, None_=None, Text=None, Image=None, StereoImage=None, Model=None, Light=None, ParticleSystem=None, **kwargs_):
        super(ContentSub, self).__init__(None_, Text, Image, StereoImage, Model, Light, ParticleSystem,  **kwargs_)
supermod.Content.subclass = ContentSub
# end class ContentSub


class LinkSub(supermod.Link):
    def __init__(self, Enabled=True, RemainEnabled=True, EnabledColor='0,128,255', SelectedColor='255,0,0', Actions=None, **kwargs_):
        super(LinkSub, self).__init__(Enabled, RemainEnabled, EnabledColor, SelectedColor, Actions,  **kwargs_)
...
class TimelineSub(supermod.Timeline):
    def __init__(self, name=None, start_immediately=True, TimedActions=None, **kwargs_):
        super(TimelineSub, self).__init__(name, start_immediately, TimedActions,  **kwargs_)
...
class ActionsTypeSub(supermod.ActionsType):
    def __init__(self, ObjectChange=None, GroupRef=None, TimerChange=None, SoundRef=None, Event=None, MoveCave=None, Restart=None, extensiontype_=None, **kwargs_):
        super(ActionsTypeSub, self).__init__(ObjectChange, GroupRef, TimerChange, SoundRef, Event, MoveCave, Restart, extensiontype_,  **kwargs_)
supermod.ActionsType.subclass = ActionsTypeSub
# end class ActionsTypeSub


class TimerChangeSub(supermod.TimerChange):
    def __init__(self, name=None, start=None, stop=None, continue_=None, start_if_not_started=None, **kwargs_):
        super(TimerChangeSub, self).__init__(name, start, stop, continue_, start_if_not_started,  **kwargs_)
...
class SoundSub(supermod.Sound):
    def __init__(self, name=None, filename=None, autostart=False, Mode=None, Repeat=None, Settings=None, **kwargs_):
        super(SoundSub, self).__init__(name, filename, autostart, Mode, Repeat, Settings,  **kwargs_)
supermod.Sound.subclass = SoundSub
# end class SoundSub


class EventTriggerSub(supermod.EventTrigger):
    def __init__(self, enabled=True, name=None, duration=0.0, remain_enabled=True, HeadTrack=None, MoveTrack=None, Actions=None, **kwargs_):
        super(EventTriggerSub, self).__init__(enabled, name, duration, remain_enabled, HeadTrack, MoveTrack, Actions,  **kwargs_)
supermod.EventTrigger.subclass = EventTriggerSub
# end class EventTriggerSub


class BoxSub(supermod.Box):
    def __init__(self, ignore_Y=True, corner1=None, corner2=None, Movement=None, **kwargs_):
        super(BoxSub, self).__init__(ignore_Y, corner1, corner2, Movement,  **kwargs_)
...
class ParticleActionListSub(supermod.ParticleActionList):
    def __init__(self, name=None, Source=None, Vel=None, ParticleAction=None, RemoveCondition=None, **kwargs_):
        super(ParticleActionListSub, self).__init__(name, Source, Vel, ParticleAction, RemoveCondition,  **kwargs_)
...
class ParticleActionSub(supermod.ParticleAction):
    def __init__(self, Avoid=None, Bounce=None, Gravity=None, Damping=None, Gravitate=None, Follow=None, MatchVel=None, OrbitPoint=None, Jet=None, RandomVel=None, RandomAccel=None, RandomDisplace=None, TargetColor=None, TargetSize=None, TargetVel=None, **kwargs_):
        super(ParticleActionSub, self).__init__(Avoid, Bounce, Gravity, Damping, Gravitate, Follow, MatchVel, OrbitPoint, Jet, RandomVel, RandomAccel, RandomDisplace, TargetColor, TargetSize, TargetVel,  **kwargs_)
...
class TransitionSub(supermod.Transition):
    def __init__(self, duration=1.0, Visible=None, Movement=None, MoveRel=None, Color='255,255,255', Scale=1.0, Sound=None, LinkChange=None, **kwargs_):
...
class TextTypeSub(supermod.TextType):
    def __init__(self, horiz_align='center', vert_align='center', font=None, depth=0.0, text=None, **kwargs_):
        super(TextTypeSub, self).__init__(horiz_align, vert_align, font, depth, text,  **kwargs_)
...
class StereoImageTypeSub(supermod.StereoImageType):
    def __init__(self, left_image=None, right_image=None, **kwargs_):
        super(StereoImageTypeSub, self).__init__(left_image, right_image,  **kwargs_)
...
class ModelTypeSub(supermod.ModelType):
    def __init__(self, filename=None, check_collisions=False, **kwargs_):
        super(ModelTypeSub, self).__init__(filename, check_collisions,  **kwargs_)
supermod.ModelType.subclass = ModelTypeSub
# end class ModelTypeSub


class LightTypeSub(supermod.LightType):
    def __init__(self, diffuse=True, specular=True, const_atten=1.0, lin_atten=0.0, quad_atten=0.0, Point=None, Directional=None, Spot=None, **kwargs_):
        super(LightTypeSub, self).__init__(diffuse, specular, const_atten, lin_atten, quad_atten, Point, Directional, Spot,  **kwargs_)
...
class ParticleSystemTypeSub(supermod.ParticleSystemType):
    def __init__(self, max_particles=1000, actions_name=None, particle_group=None, look_at_camera=False, sequential=False, speed=1.0, **kwargs_):
        super(ParticleSystemTypeSub, self).__init__(max_particles, actions_name, particle_group, look_at_camera, sequential, speed,  **kwargs_)
...
class ActionsType1Sub(supermod.ActionsType1):
    def __init__(self, ObjectChange=None, GroupRef=None, TimerChange=None, SoundRef=None, Event=None, MoveCave=None, Restart=None, Clicks=None, **kwargs_):
        super(ActionsType1Sub, self).__init__(ObjectChange, GroupRef, TimerChange, SoundRef, Event, MoveCave, Restart, Clicks,  **kwargs_)
...
class TimedActionsTypeSub(supermod.TimedActionsType):
    def __init__(self, ObjectChange=None, GroupRef=None, TimerChange=None, SoundRef=None, Event=None, MoveCave=None, Restart=None, seconds_time=None, **kwargs_):
        super(TimedActionsTypeSub, self).__init__(ObjectChange, GroupRef, TimerChange, SoundRef, Event, MoveCave, Restart, seconds_time,  **kwargs_)
...
class MoveCaveTypeSub(supermod.MoveCaveType):
    def __init__(self, duration=0.0, Relative=None, Absolute=None, Placement=None, **kwargs_):
        super(MoveCaveTypeSub, self).__init__(duration, Relative, Absolute, Placement,  **kwargs_)
...
class RepeatTypeSub(supermod.RepeatType):
    def __init__(self, NoRepeat=None, RepeatForever=None, RepeatNum=None, **kwargs_):
        super(RepeatTypeSub, self).__init__(NoRepeat, RepeatForever, RepeatNum,  **kwargs_)
...
class DirectionTypeSub(supermod.DirectionType):
    def __init__(self, PointTarget=None, DirectionTarget=None, ObjectTarget=None, None_=None, **kwargs_):
        super(DirectionTypeSub, self).__init__(PointTarget, DirectionTarget, ObjectTarget, None_,  **kwargs_)
...
class DirectionTargetTypeSub(supermod.DirectionTargetType):
    def __init__(self, direction=None, angle=30, **kwargs_):
        super(DirectionTargetTypeSub, self).__init__(direction, angle,  **kwargs_)
...
class RemoveConditionTypeSub(supermod.RemoveConditionType):
    def __init__(self, Age=None, Position=None, Velocity=None, **kwargs_):
        super(RemoveConditionTypeSub, self).__init__(Age, Position, Velocity,  **kwargs_)
...
class PositionType4Sub(supermod.PositionType4):
    def __init__(self, inside=False, ParticleDomain=None, **kwargs_):
        super(PositionType4Sub, self).__init__(inside, ParticleDomain,  **kwargs_)
...
class VelocityTypeSub(supermod.VelocityType):
    def __init__(self, inside=False, ParticleDomain=None, **kwargs_):
        super(VelocityTypeSub, self).__init__(inside, ParticleDomain,  **kwargs_)
supermod.VelocityType.subclass = VelocityTypeSub
# end class VelocityTypeSub


class AvoidTypeSub(supermod.AvoidType):
    def __init__(self, magnitude=None, epsilon=0.001, lookahead=None, ParticleDomain=None, **kwargs_):
        super(AvoidTypeSub, self).__init__(magnitude, epsilon, lookahead, ParticleDomain,  **kwargs_)
supermod.AvoidType.subclass = AvoidTypeSub
# end class AvoidTypeSub


class BounceTypeSub(supermod.BounceType):
    def __init__(self, friction=None, resilience=None, cutoff=None, ParticleDomain=None, **kwargs_):
        super(BounceTypeSub, self).__init__(friction, resilience, cutoff, ParticleDomain,  **kwargs_)
...
class DampingTypeSub(supermod.DampingType):
    def __init__(self, direction=None, vel_low=0.0, vel_high=0.0, **kwargs_):
        super(DampingTypeSub, self).__init__(direction, vel_low, vel_high,  **kwargs_)
supermod.DampingType.subclass = DampingTypeSub
# end class DampingTypeSub


class GravitateTypeSub(supermod.GravitateType):
    def __init__(self, magnitude=1.0, epsilon=0.001, max_radius=0.0, **kwargs_):
        super(GravitateTypeSub, self).__init__(magnitude, epsilon, max_radius,  **kwargs_)
...
class FollowTypeSub(supermod.FollowType):
    def __init__(self, magnitude=1.0, epsilon=0.001, max_radius=0.0, **kwargs_):
        super(FollowTypeSub, self).__init__(magnitude, epsilon, max_radius,  **kwargs_)
...
class MatchVelTypeSub(supermod.MatchVelType):
    def __init__(self, magnitude=1.0, epsilon=0.001, max_radius=0.0, **kwargs_):
        super(MatchVelTypeSub, self).__init__(magnitude, epsilon, max_radius,  **kwargs_)
supermod.MatchVelType.subclass = MatchVelTypeSub
# end class MatchVelTypeSub


class OrbitPointTypeSub(supermod.OrbitPointType):
    def __init__(self, center=None, magnitude=1.0, epsilon=0.001, max_radius=0.0, **kwargs_):
        super(OrbitPointTypeSub, self).__init__(center, magnitude, epsilon, max_radius,  **kwargs_)
...
class JetTypeSub(supermod.JetType):
    def __init__(self, ParticleDomain=None, AccelDomain=None, **kwargs_):
        super(JetTypeSub, self).__init__(ParticleDomain, AccelDomain,  **kwargs_)
...
class TargetColorTypeSub(supermod.TargetColorType):
    def __init__(self, color=None, alpha=1.0, scale=None, **kwargs_):
        super(TargetColorTypeSub, self).__init__(color, alpha, scale,  **kwargs_)
...
class SphereTypeSub(supermod.SphereType):
    def __init__(self, center=None, radius=None, radius_inner=0.0, **kwargs_):
        super(SphereTypeSub, self).__init__(center, radius, radius_inner,  **kwargs_)
supermod.SphereType.subclass = SphereTypeSub
# end class SphereTypeSub


class CylinderTypeSub(supermod.CylinderType):
    def __init__(self, p1=None, p2=None, radius=None, radius_inner=0.0, **kwargs_):
        super(CylinderTypeSub, self).__init__(p1, p2, radius, radius_inner,  **kwargs_)
supermod.CylinderType.subclass = CylinderTypeSub
# end class CylinderTypeSub


class ConeTypeSub(supermod.ConeType):
    def __init__(self, base_center=None, apex=None, radius=None, radius_inner=0.0, **kwargs_):
        super(ConeTypeSub, self).__init__(base_center, apex, radius, radius_inner,  **kwargs_)
...
class DiscTypeSub(supermod.DiscType):
    def __init__(self, center=None, normal=None, radius=None, radius_inner=0.0, **kwargs_):
