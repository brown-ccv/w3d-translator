...
#
# Command line:
#   ..\..\Apps\generateDS\generateDS.py -o "generateDS/classes.py" --no-dates --no-versions --no-namespace-defs .\schema\caveschema.xsd
#
...
class Global(GeneratedsSuper):
    ...
    def _hasContent(self):
        if (
            self.CameraPos is not None
            or self.CaveCameraPos is not None
    ...
    def _exportChildren(
        ...
        if self.CameraPos is not None:
            namespaceprefix_ = (
                self.CameraPos_nsprefix_ + ":"
                if (UseCapturedNS_ and self.CameraPos_nsprefix_)
                else ""
            )
            self.CameraPos.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
        ...
        if self.CaveCameraPos is not None:
            namespaceprefix_ = (
                self.CaveCameraPos_nsprefix_ + ":"
                if (UseCapturedNS_ and self.CaveCameraPos_nsprefix_)
                else ""
            )
            self.CaveCameraPos.export(
                outfile,
                level,
                namespaceprefix_,
                namespacedef_="",
